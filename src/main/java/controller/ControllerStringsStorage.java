...
public class ControllerStringsStorage {
    ...
    public static final String WRONG_IMAGE_PATH_FORMAT = "Wrong image path format!";
    public static final String NEGATIVE_NUMBER_OR_NOT_NUMBER = "You entered a negative number or not a number at all!";
    public static final String IS_NOT_ALLOWED_CAR_TYPE_TO_BE_ADDED = "Wrong car type!Allowed car types: sedan, hatchback, coupe, cross, offRoad, minivan";
    public static final String SEDAN = "sedan";
    public static final String HATCHBACK = "hatchback";
    public static final String COUPE = "coupe";
    public static final String CROSSOVER = "cross";
    ...
    public static final String NOT_EXISTING_EMAIL = "given email wasn't registered";
